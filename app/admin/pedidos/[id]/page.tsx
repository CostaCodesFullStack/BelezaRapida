      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-2">
            Pedido <span className="text-muted-foreground text-xl">#{order.id.slice(-8).toUpperCase()}</span>
          </h1>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              {order.customerCpf && <p className="text-muted-foreground">CPF: {order.customerCpf}</p>}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              {addressInfo.street ? (
                <>
                  <p>{addressInfo.street}, {addressInfo.number} {addressInfo.complement ? ` - ${addressInfo.complement}` : ""}</p>
